...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       $ git clone git@github.com:VNG-Realisatie/verzoeken-api verzoeken
       $ cd verzoeken
...
``src/verzoeken/conf/local.py``. You can base this file on the
...
.. code-block:: bash
    ...
    $ python src/manage.py test verzoeken
...
1. Clone or download the code from `Github`_ in a folder like
   ...
   .. code-block:: bash
       ...
       $ git clone git@bitbucket.org:VNG-Realisatie/verzoeken-api verzoeken
       Cloning into 'verzoeken'...
       ...
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       $ docker-compose up -d
       Starting verzoeken_db_1 ... done
       Starting verzoeken_web_1 ... done
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       $ docker exec -it verzoeken_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       $ docker exec -it verzoeken_web_1 /app/src/manage.py loaddata admin_index groups
...
environment variables. See ``src/verzoeken/conf/docker.py`` for
all settings.
...
.. code-block:: bash
    ...
    $ docker build . && docker run \
        -p 8000:8000 \
        -e DJANGO_SETTINGS_MODULE=verzoeken.conf.docker \
        -e DATABASE_USERNAME=... \
        -e DATABASE_PASSWORD=... \
        -e DATABASE_HOST=... \
        --name verzoeken

    $ docker exec -it verzoeken /app/src/manage.py createsuperuser
